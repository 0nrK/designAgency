...
const Services = () => {
    return (
        <div >
            <div className="flex flex-col flex-wrap md:space-y-0 md:space-x-5 space-y-4 p-4 grayscale md:flex-row justify-around align-center py-32">
                ...
                <div className="relative w-full md:flex-1 flex drop-shadow-lg  justify-center align-center text-center h-96 cursor-pointer">
                    <img
                        className="object-cover h-96 w-full  md:h-auto"
                        alt=""
